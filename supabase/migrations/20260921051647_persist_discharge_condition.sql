-- Persist discharge status/complaints for discharged cases.

alter table public.cases
  add column if not exists discharge_condition text not null default '';
...
begin
  ...
  insert into public.cases (
    ...
    disposition, discharge_condition, recommendations, hospital, ward, accepting_physician,
  ...
  values (
    ...
    coalesce(p_case->>'discharge_condition', ''),
